 ...
 * @brief Add new button in the alert view with block handler.
 ...
 * @brief Add new cancel button in the alert view with block handler. The cancel button adds as last button.
